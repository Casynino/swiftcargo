...
const NO_TRAIL_NEEDED: Record<string, string> = {
  ...
  "requests.ts:submitQuoteRequest": "a public form; the request is the record",
  "requests.ts:submitPickupRequest": "a public form; the request is the record",
  "requests.ts:submitBooking": "a public form; the request is the record",
