...
function RemoveForm({
  ...
  return (
    <form action={action} className="space-y-3">
      ...
      <Input name="reason" required minLength={3} placeholder="Why it is being removed" className="h-9" />
        ...
        <form action={editAction} className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div className="space-y-1.5">
              <Label className="text-xs">Kind of goods</Label>
              <Input
                name="cargoType"
                list={listId}
            ...
            <div className="space-y-1.5">
              <Label className="text-xs">Charged by</Label>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1.5">
                <Label className="text-xs">Min CBM</Label>
          ...
          <label className="flex items-center gap-2 text-xs">
            ...
            Show on the public rates page
          </label>
          <Input name="reason" required minLength={3} placeholder="Why the rate is changing" className="h-9" />
          <p className="text-[11px] text-muted-foreground">
            New bills use the new figures. Bills already raised keep the rate they were priced at.
          </p>
    ...
    <div className="w-full">
      ...
      {mode === "edit" ? (
        ...
        <form action={editAction} className="flex flex-wrap items-end gap-2">
          ...
          <Input name="reason" required minLength={3} placeholder="Why it is changing" className="h-9 min-w-48 flex-1" />
  ...
  return (
    <div>
      {open ? (
        ...
        >
          <Trash2 className="size-3.5" />
          Published by mistake? Withdraw it
        </button>
      )}
